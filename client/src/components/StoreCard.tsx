...
export function StoreCard({ store, index }: { store: Store; index: number }) {
  return (
    ...
    >
      <div className="relative aspect-[4/3] rounded-[2.5rem] overflow-hidden mb-6 shadow-[0_15px_45px_rgb(0,0,0,0.06)] dark:shadow-[0_15px_45px_rgb(0,0,0,0.3)] group-hover:shadow-[0_30px_70px_rgba(0,157,224,0.25)] transition-all duration-700">
        ...
        <div className="absolute bottom-6 left-6 z-20">
            <motion.div 
              ...
              className="bg-white/95 dark:bg-card/95 backdrop-blur-xl px-5 py-2.5 rounded-[1.25rem] shadow-2xl flex items-center gap-3 text-sm font-black text-foreground"
            >
      ...
      <div className="px-2">
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex items-center bg-gray-100/80 dark:bg-white/10 px-3 py-1 rounded-xl shrink-0">
            <span className="text-sm font-black text-gray-800 dark:text-gray-200 tracking-tight">8.9</span>
          </div>
        </div>
        
        <p className="text-gray-500 dark:text-muted-foreground text-base font-bold mb-3 truncate">
          {store.description}
        </p>
        ...
        <div className="flex items-center gap-4 text-base font-black">
          ...
          <div className="flex items-center gap-2">
            <span className="bg-blue-50 dark:bg-primary/15 text-primary text-[11px] font-black px-3 py-1 rounded-lg uppercase tracking-widest border border-blue-100 dark:border-primary/30">
                Wolt+
            </span>
          </div>
        </div>
